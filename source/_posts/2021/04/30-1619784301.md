...
{% gp 2-2 %}
![](https://cdn.staticaly.com/gh/ProgCZ/image-cloud-a/master/2021/04/01.png)
![](https://cdn.staticaly.com/gh/ProgCZ/image-cloud-a/master/2021/04/02.png)
{% endgp %}
...
![](https://cdn.staticaly.com/gh/ProgCZ/image-cloud-a/master/2021/04/03.png)
...
1. 替换站点标题中不规范的部分
    ...
    ![](https://cdn.staticaly.com/gh/ProgCZ/image-cloud-a/master/2021/04/04.png)

    替换后：

    ![](https://cdn.staticaly.com/gh/ProgCZ/image-cloud-a/master/2021/04/05.png)

2. 替换归档页面中不规范的部分

    归档页面中，表达冗余，且英文叹号也不符合中文排版规范：

    ![](https://cdn.staticaly.com/gh/ProgCZ/image-cloud-a/master/2021/04/06.png)

    替换后：

    ![](https://cdn.staticaly.com/gh/ProgCZ/image-cloud-a/master/2021/04/07.png)

3. 替换文章信息中不规范的部分

    这个单纯是我看中文逗号不顺眼，不能表达分类之间的层级关系：

    ![](https://cdn.staticaly.com/gh/ProgCZ/image-cloud-a/master/2021/04/08.png)

    替换后：

    ![](https://cdn.staticaly.com/gh/ProgCZ/image-cloud-a/master/2021/04/09.png)

4. 替换页脚中不规范的部分

    这个也单纯是我看 copyright 字符不顺眼，有点矮：

    ![](https://cdn.staticaly.com/gh/ProgCZ/image-cloud-a/master/2021/04/10.png)

    替换后：

    ![](https://cdn.staticaly.com/gh/ProgCZ/image-cloud-a/master/2021/04/11.png)
